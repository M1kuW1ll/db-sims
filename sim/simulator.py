...
class LocationGamesSimulator:
    ...
    which are generated stochastically from information sources. Builders learn
    and adapt their region choices over time based on observed rewards or
    exact-response dynamics.
    """
